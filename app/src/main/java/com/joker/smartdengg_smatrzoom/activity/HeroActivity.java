...
public class HeroActivity extends AppCompatActivity {
    ...
    @NonNull
    @Bind((R.id.hero_layout_square_iv))
    ...
    public static void navigateToHeroActivity(@NonNull Activity startingActivity, @NonNull Rect startBounds, @NonNull Point globalOffset) {

        Intent intent = new Intent(startingActivity, HeroActivity.class);
        intent.putExtra(RECT, startBounds)
              .putExtra(POINT, globalOffset);
    ...
    private void runEnterAnimation(Bundle extras) {
        ...
        Picasso.with(HeroActivity.this)
               .load(R.drawable.one)
               .noFade()
               .into(heroIv, new Callback.EmptyCallback() {
                   @Override
    ...
    protected void runExitAnimator() {
        ...
        animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.heroIv, View.X, startBounds.left))
    ...
    @NonNull
    @OnClick(R.id.hero_layout_cancel_iv)
    void onCancelClick() {
